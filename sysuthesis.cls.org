...
\RequirePackage[top=2.5cm,bottom=2.5cm,left=2.8cm,right=2.2cm]{geometry} %版面设置
...
\newpagestyle{sysufrontstyle}{
  \sethead[][{\song{}\xiaowuhao{}中山大学\@degree{}学位论文}][]
  {}{{\song{}\xiaowuhao{}中山大学\@degree{}学位论文}}{}
  \setfoot{}{\thepage}{}
  \headrule
}
...
\newcommand{\chinesecover}{  
  ...
  \begin{center}
    \begin{tabular}{rc}
      \makebox[5em][s]{\authorpre} ：   &\underline{\hspace{2.4cm}\@author\hspace{2.4cm}}\medskip\\
      \makebox[5em][s]{\advisorpre} ：  &\underline{\hspace{2.3cm}\@advisorname\,\,\@advisortitle\hspace{2.3cm}}\medskip \\
      \makebox[5em][s]{\majornamepre} ：&\underline{\hspace{2.4cm}\@major\hspace{2.4cm}}\medskip\\
	                  & \\
					  & \\
					  
	  \committeechairpre ：&\underline{\hspace{5cm}}\medskip\\
      \committeemempre ：&\underline{\hspace{5cm}}\medskip\\
...
\renewcommand{\bibliography}[1]{
  ...
  \pagestyle{sysufrontstyle}} % 恢复原有样式给后续部分
